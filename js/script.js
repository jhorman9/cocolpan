...
const imgBanner = document.querySelector(".main-slider");
const allImages = document.querySelectorAll(".img-banner_principal");
const swiperConverter = document.querySelector(".mySwiper");

  allImages.forEach(image => {
    imgBanner.style.height = `${image.clientHeight}px`;
    swiperConverter.style.height = `${image.clientHeight}px`;
  });